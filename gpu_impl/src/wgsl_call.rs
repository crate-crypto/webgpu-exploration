...
/// this marco is used for linking different wgsl file into the same file
...
/// function for running the wgsl code
/// input data:
/// numbers - input data for the wgsl function
/// func_name - name of the wgsl function
/// binding_number - number of bindings needed to run the wgsl function
/// output data:
/// the output of the wgsl function
...
/// Buffer that store all bindings
pub struct BufCoder {
	staging_buffer: Buffer,
}

impl BufCoder {
    /// initializes all buffers, that will store the information about input and output data
	/// input data:
	/// gpu - const that store information about the chosen gpu
	/// numbers - input data for the wgsl function
	/// func_name - name of the wgsl function
	/// binding_number - number of bindings needed to run the wgsl function
	/// output data:
...
/// constants that are needed for running the gpu
...
impl GpuConsts {
    /// initializes gpu constants for running
	...
	/// sends information from Rust to WGSL, executes WGSL function and gets the result of the WGSL function
...
/// struct for storing information about the input and output data that is transferring from Rust to WGSL and back
pub struct Bindings {
...
/// initialization of different number of bindings
impl Bindings {
